...
generateBtnElem.addEventListener('click', function (e) {
  resultElem.innerHTML = ''; // یادآوری : اگر از قسمت کامنت  شده استفاده شود این قسمت باید حذف شود
  e.preventDefault()
  ...
  slicedArray.forEach(function (text){   // یادآوری : اگر از قسمت کامنت  شده استفاده شود این قسمت باید حذف شود
    resultElem.innerHTML += '<p>'+ text + '</p>'; //
